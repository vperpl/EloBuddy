namespace Velkoz
{
    ...
    public static class Interrupter
    {
            ...
            return
                Spells.Any(
                    ...
                    && ((unit.LastCastedspell() != null
                         ...
                         && EloBuddy.SDK.Core.GameTickCount - unit.LastCastedSpellT() < 350 + spell.ExtraDuration)
                        ...
                        || (unit.IsMe && LastCastedSpell.LastCastPacketSent != null
                            ...
                            && EloBuddy.SDK.Core.GameTickCount - LastCastedSpell.LastCastPacketSent.Tick < 150 + Game.Ping)));
        }
        ...
        {
            foreach (var enemy in ObjectManager.Get<AIHeroClient>().Where(e => e.IsValidTarget(null, true)))
            {
