...
namespace Evade
{
    ...
    internal class EvadeSpellData
    {
        ...
        public int DangerLevel
        {
            get
            {
                if (Config.EvadeSpellMenu["DangerLevel" + Name] != null)
                {
                    return Config.EvadeSpellMenu["DangerLevel" + Name].Cast<Slider>().CurrentValue;
                }
                return _dangerLevel;
            }
        }
        ...
        public bool Enabled
        {
            get
            {
                if (Config.EvadeSpellMenu["Enabled" + Name] != null)
                {
                    return Config.EvadeSpellMenu["Enabled" + Name].Cast<CheckBox>().CurrentValue;
                }
                return true;
            }
        }
