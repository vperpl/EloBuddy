    ...
    public static class Geometry
    {
        ...
        public class Polygon
        {
            ...
            public void Draw(Color color, int width = 1)
            {
                for (var i = 0; i <= Points.Count - 1; i++)
                {
                    ...
                    Utils.DrawLineInWorld(Points[i].To3DWorld(), Points[nextIndex].To3DWorld(), width, color);
                }
            }
        }
        ...
        public class Arc
        {
            ...
            public Polygon ToPolygon(int offset = 0)
            {
                ...
                EloBuddy.SDK.Rendering.Circle.Draw(SharpDX.Color.White, 100, innerCenter.To3D());
